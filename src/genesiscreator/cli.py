...
from genesiscreator.block import *
...
def main(argv=sys.argv):
    ...
    block_data = create_block(args.pszTimestamp, args.pubkey, args.nValue, args.algorithm, args.nTime, args.nBits, args.nNonce, args.nVersion)

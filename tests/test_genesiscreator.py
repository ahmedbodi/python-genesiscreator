...
def test_sha256_bitcoin():
    block_data = create_block("The Times 03/Jan/2009 Chancellor on brink of second bailout for banks",
...
def test_scrypt_litecoin():
    block_data = create_block("NY Times 05/Oct/2011 Steve Jobs, Apple’s Visionary, Dies at 56",
...
def test_x11_dash():
    block_data = create_block("Wired 09/Jan/2014 The Grand Experiment Goes Live: Overstock.com Is Now Accepting Bitcoins",
	"040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9",
	50 * COIN, "X11", 1390095618, 0x1e0ffff0, 28917698, 1, True)
...
def test_quark_pivx():
    block_data = create_block("U.S. News & World Report Jan 28 2016 With His Absence, Trump Dominates Another Debate",
	...
	250 * COIN, "Quark", 1454124731, 0x1e0ffff0, 2402015, 1, True)
